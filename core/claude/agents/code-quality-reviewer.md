...
description: Reviews code changes for quality issues — redundant state, parameter sprawl, copy-paste, leaky abstractions, stringly-typed code, and standards violations.
...
- [ ] Constitution standards checked (if provided)
