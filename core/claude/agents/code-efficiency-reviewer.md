...
description: Reviews code changes for efficiency issues — unnecessary work, hot-path bloat, runtime risks, side effects, and memory problems.
...
| `constitution-context` | Project code standards summary (if available) |
...
handoff:
  ...
  agent: "code-efficiency-reviewer"
  findings:
    - id: 1
      finding: "{description of efficiency issue}"
