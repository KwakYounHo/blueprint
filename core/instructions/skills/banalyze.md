...
Delegate to Phase Analyzer agents in parallel (1 per Phase):
...
[PLATFORM: user-interaction]
Ask user: "Bare repo detected. Create worktree for this plan?"
...
[PLATFORM: user-interaction]
Ask user: "Protected branch ({current_branch}) detected. Create feature branch?"
