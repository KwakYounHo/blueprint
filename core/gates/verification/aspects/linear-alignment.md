...
skip_reason: "source-discussion is null"  # Only when status: skip
issues:
  - status: warning
    message: "Linear issue scope broader than Plan scope"
    linear_scope: "Summary of Linear issue"
    plan_scope: "Summary of Plan scope"
    suggestion: "Verify intended scope with stakeholders"
```
