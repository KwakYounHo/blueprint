...
issues:
  - criterion_id: 2
    status: fail
    message: "Only 4 of 6 aspects defined"
    verification: "File count in core/gates/verification/aspects/"
    expected: 6
    actual: 4
    suggestion: "Create missing aspect files: deviations.md, linear-alignment.md"
```
