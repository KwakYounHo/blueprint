...
status: pass | warning
deviations_found: 2
deviations_documented: 1
issues:
  - task: "T-2.4"
    status: warning
    message: "Undocumented deviation from Plan deliverable"
    plan_says: "5 new OBJECTIVE blocks"
    actual: "4 OBJECTIVE blocks"
    suggestion: "Add Deviation entry in implementation-notes.md"
```
