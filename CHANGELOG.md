...
- **BREAKING**: Rename `/plan` command to `/bplan` (avoid conflict with Claude Code built-in `/plan`)
...
[0.3.0]: https://github.com/KwakYounHo/blueprint/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/KwakYounHo/blueprint/compare/v0.1.0...v0.2.0
